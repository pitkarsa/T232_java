		...
		while(true) {
			...
			case 4: // Update Flight Data
				...
				if(index !=-1) {
					...
					System.err.println("could not get the required flight details");
				}				
				break;
			case 5: // Delete Flight Data
				...
				if(index !=-1) {
					// if the flight is found, delete it
					flights.remove(index);
					System.out.println("Flight deleted successfully!!");
				}
				else {
					System.err.println("could not delete the flight details");
				}				
				break;
